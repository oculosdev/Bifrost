...
namespace Bifrost.Specs.Security.for_SecurityDescriptor
{
    ...
    public class when_checking_can_authorize_on_command_in_secured_namespace_for_when_not_handling_command : given.a_configured_security_descriptor_for_commands
    {
