...
namespace Bifrost.Events.Azure.ServiceBus
{
    ...
    /// </summary>
    public class CommittedEventStreamQueueReceiver : ICanReceiveCommittedEventStream
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="CommittedEventStreamQueueReceiver"/>
        /// </summary>
        ...
        public CommittedEventStreamQueueReceiver(
